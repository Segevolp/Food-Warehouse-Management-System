...
class Volunteer {
    public:
        ...
        Volunteer(const Volunteer& copyThis);
        int getId() const;
...
class CollectorVolunteer: public Volunteer {
    ...
    public:
        ...
        CollectorVolunteer(const CollectorVolunteer& copyThis);
...
class LimitedCollectorVolunteer: public CollectorVolunteer {
    ...
    public:
        ...
        LimitedCollectorVolunteer(const LimitedCollectorVolunteer& copyThis);
...
class DriverVolunteer: public Volunteer {
    ...
    public:
        ...
        DriverVolunteer(const DriverVolunteer& copyThis);
...
class LimitedDriverVolunteer: public DriverVolunteer {
    ...
    public:
        ...
        LimitedDriverVolunteer(const LimitedDriverVolunteer& copyThis);
